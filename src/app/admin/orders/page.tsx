...
export default function OrdersPage() {
  ...
  const [currentStatus, setCurrentStatus] =
    useState<OrderStatus>("Verarbeitung");
                ...
                <TableCell>
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      >
                        <DropdownMenuRadioItem value="Verarbeitung">
                          Verarbeitung
                        </DropdownMenuRadioItem>
                        <DropdownMenuRadioItem value="Versendet">
                          Versendet
                        </DropdownMenuRadioItem>
                        <DropdownMenuRadioItem value="Geliefert">
                          Geliefert
                        </DropdownMenuRadioItem>
                        <DropdownMenuRadioItem value="Storniert">
                          Storniert
                        </DropdownMenuRadioItem>
                      </DropdownMenuRadioGroup>
                    </DropdownMenuContent>
