  ...
  return (
    ...
    >
      ...
      {cartItems.length === 0 ? (
        ...
        <motion.div className="grid lg:grid-cols-3 gap-12" variants={containerVariants}>
                ...
                <Card>
                    ...
                    <CardContent>
                        <motion.div className="space-y-6" variants={containerVariants}>
                            {cartItems.map(item => (
                                <motion.div key={item.id} className="flex flex-col sm:flex-row items-center justify-between" variants={itemVariants}>
                                    <div className="flex items-center gap-4 mb-4 sm:mb-0">
                                        {item.image && (
                                            <Image src={item.image} alt={item.name} width={80} height={80} className="rounded-md object-cover" data-ai-hint={item.name}/>
                                        )}
                                        <div>
