...
export default function CheckoutPage() {
  ...
  const [orderStatus, setOrderStatus] = useState<"success" | "failure">(
    "failure"
  );
  ...
  const onSubmit: SubmitHandler<ShippingFormValues> = (data) => {
    ...
    if (isSuccess && cartItems.length > 0) {
      ...
      toast({
        ...
        description:
          "Ihre Zahlung war erfolgreich und Ihre Bestellung ist auf dem Weg.",
        variant: "default",
        duration: 5000,
      });
      clearCart();
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  onValueChange={(value) =>
                    ((control as any)._formValues.country = value)
                  }
              ...
              <Tabs defaultValue="card" className="w-full">
                ...
                <TabsContent value="paypal" className="mt-6 text-center">
                  <p className="text-muted-foreground mb-4">
                    Sie werden zu PayPal weitergeleitet, um Ihren Kauf
                    abzuschließen.
                  </p>
                  <Button type="submit" className="w-full" size="lg">
                    Weiter mit PayPal
                ...
                <TabsContent value="crypto" className="mt-6 text-center">
                  <p className="text-muted-foreground mb-4">
                    Wählen Sie Ihre Kryptowährung, um fortzufahren.
                  </p>
                  <Button type="submit" className="w-full" size="lg">
                    Mit Krypto bezahlen
                  </Button>
                ...
                <TabsContent value="cod" className="mt-6 text-center">
                  <p className="text-muted-foreground mb-4">
                    Sie können bei Lieferung Ihrer Bestellung bar bezahlen.
                  </p>
                  <Button type="submit" className="w-full" size="lg">
