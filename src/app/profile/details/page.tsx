...
export default function UserDetailsPage() {
        ...
        return (
             <Card>
                <CardHeader>
                    ...
                    <CardDescription>Bitte melden Sie sich an, um Ihre Daten anzuzeigen.</CardDescription>
                </CardHeader>
            </Card>
        )
    }
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Meine Daten</CardTitle>
                <CardDescription>Sehen und aktualisieren Sie Ihre persönlichen Informationen.</CardDescription>
            </CardHeader>
            <CardContent>
